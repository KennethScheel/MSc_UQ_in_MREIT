...
File(folder + 'problem62_2D_sigma_true.pvd')<<sigma_true_file
...
File(folder + 'problem62_2D_sigma_parameter_mean.pvd')<<sigma_param_mean
...
File(folder + 'problem62_2D_sigma_pushforward_mean.pvd')<<sigma_push_mean_file
...
File(folder + 'problem62_2D_sigma_pushforward_std.pvd')<<sigma_push_std_file
